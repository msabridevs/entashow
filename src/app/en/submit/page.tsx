...
export default function SubmitEN() {
  ...
  async function submit() {
    ...
    if (!res.ok) {
      setMsg("Failed. Please fill all fields correctly.");
      return;
    }

    setMsg("Received ✅ One Independent script may be selected each round for voting.");
    setEmail("");
    setTitle("");
    setSynopsis("");
    setScript("");
  ...
  return (
    <main dir="ltr" style={{ maxWidth: 820, margin: "40px auto", padding: 16, fontFamily: "system-ui, Arial" }}>
      <h1>Submit your script (Independent)</h1>
      <p style={{ opacity: 0.8 }}>
        Your script will be stored for review. One may be selected each round to be voted on under “Independent”.
      </p>
      ...
      <label style={labelStyle}>Short synopsis</label>
      ...
      <p style={{ marginTop: 18 }}>
        <a href="/en/explore">← Back to voting</a>
      </p>
    </main>
  );
}
